...
<head>
    ...
    <noscript>
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Otomanopee+One:400&display=swap">
    </noscript>
    ...
    <noscript>
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Outfit:100,200,300,400,500,600,700,800,900&display=swap">
    </noscript>
...
<body>
            ...
            <div class="container-fluid">
                <div class="navbar-brand">
                    <span class="navbar-logo">
                        <a href="#">
                            <img src="assets/images/logo.png" alt="" style="height: 4.5rem;">
                        </a>
                    </span>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-lg-7">
                    <div class="content">
                        <h2 class="mbr-section-subtitle mbr-fonts-style display-2">
                            <span>
                        ...
                        <div class="title-wrap">
                            <h1 class="mbr-section-title mbr-fonts-style display-1">
                                <strong><a href="" class="text-secondary">SNACKS</a></strong>
                                <br>
                                <strong>BRAND</strong>
                            </h1>
                            <h5 class="mbr-title-addition mbr-fonts-style display-7">
                                <span>
                                    <strong>NEWEST<br>HEALTHY<br>SNACK</strong>
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">
                            Unique taste and beneficial for your health!
                        </p>
                        <div class="mbr-section-btn justify-content-start">
                            <a class="btn btn-primary btn-size display-4" href="#"><strong>WANT IT!</strong></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-8">
                    <h4 class="mbr-section-subtitle mbr-fonts-style display-2">
                        <strong>WHAT DOES IT<br>MEAN FUNCTIONAL</strong>
                    </h4>
                    <h2 class="mbr-section-title mbr-fonts-style display-2">
                        <span class="highlight"><strong>SNACKS?</strong></span>
                    </h2>
                </div>
                    ...
                    <div class="text-wrapper">
                        <div class="title-wrap">
                            ...
                            <h6 class="card-title mbr-fonts-style display-7">
                                <strong>FUNCTIONAL SNACKS WITH<br>WELL-BALANCED INGREDIENTS</strong>
                            </h6>
                        </div>
    ...
    <section data-bs-version="5.1" class="image1 cid-sQg5Ljd1hi" id="image1-4">




        <div class="image-wrapper">
            <img src="assets/images/hightlights1.jpg" alt="">
        </div>

        <div class="container-fluid">
            <div class="row inner-image">
            ...
            <div class="row align-items-center content">
                <div class="col-12 offset-lg-6 col-lg-6">
                    <div class="text-wrapper">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">For lovers of rich chocolate flavor.
                            <br>The perfect addition to your favorite coffee.
                        </p>
                    </div>
                </div>
                <div class="col-12 offset-lg-6 col-lg-6">
                    <div class="nutrition">
                        ...
                        <div class="nutrition-wrap">
                            <div class="nutrition-tile tile-one">
                                <p class="mbr-tile-text mbr-fonts-style display-4">PROTEIN</p>
                                <p class="mbr-tile-number mbr-fonts-style display-7"><strong>12,15</strong></p>
                            </div>
                            <div class="nutrition-tile tile-two">
                                <p class="mbr-tile-text mbr-fonts-style display-4">FAT</p>
                                <p class="mbr-tile-number mbr-fonts-style display-7"><strong>12,15</strong></p>
                            </div>
                            <div class="nutrition-tile tile-three">
                                <p class="mbr-tile-text mbr-fonts-style display-4">CARBS</p>
                                <p class="mbr-tile-number mbr-fonts-style display-7"><strong>14,5</strong></p>
                            </div>
                            <div class="nutrition-tile tile-four">
                                ...
                                <p class="mbr-tile-text mbr-fonts-style display-4">ENERGY</p>
                                <p class="mbr-tile-number mbr-fonts-style display-7"><strong>205,7</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 offset-lg-6 col-lg-6">
                    <div class="price">
                        <div class="price-text-wrap">
                            <div>
                                <p class="mbr-price-text mbr-fonts-style display-7">PRICE</p>
                                <p class="mbr-price-number mbr-fonts-style display-5">$80</p>
                            </div>
                            <div class="line"></div>
                            <div>
                                <p class="mbr-amount-text mbr-fonts-style display-7">AMOUNT</p>
                                <p class="mbr-amount-number mbr-fonts-style display-5">16</p>
                            </div>
                        </div>
                    </div>
                    <div class="buttons-wrap">
                        <div class="mbr-section-btn justify-content-start">
                            <a class="btn btn-white-outline btn-size display-4" href="#"><strong>DETAILS</strong></a>
                            <a class="btn btn-size btn-secondary display-4" href="#"><strong>ADD</strong></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section data-bs-version="5.1" class="image1 cid-sQg5Qz405K" id="image1-5">
            ...
            <div class="row align-items-center content">
                <div class="col-12 offset-lg-6 col-lg-6">
                    <div class="text-wrapper">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">Almonds are a good source of nutrients
                            <br>that are important for brain health.
                        </p>
                    </div>
                </div>
                <div class="col-12 offset-lg-6 col-lg-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-8">
                    ...
                    <h2 class="mbr-section-title mbr-fonts-style display-2">
                        <span class="highlight"><strong>INGREDIENTS?</strong></span>
                    </h2>
                </div>
                <div class="col-12 col-lg-4">
                    <div class="text">
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingOne">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse1_7" aria-expanded="false" aria-controls="collapse1">
                                    ...
                                    <h5 class="panel-title-edit mbr-fonts-style display-5">
                                        <strong>GLUTEN FREE OATMEAL</strong>
                                    </h5>
                                    <h6 class="panel-subtitle-edit mbr-fonts-style display-4">
                                        GREAT SOURCE<br>OF COMPLEX CARBS
                                    </h6>
                            ...
                            <div id="collapse1_7" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne">
                                <div class="panel-body">
                                    ...
                                    <div class="panel-content">
                                        <p class="mbr-fonts-style panel-text display-4">Gluten-free oat flakes from naked oats contain 1.5 times more * oat oil and natural vitamin E, are rich in vitamins B1, B2, B6, carotene, magnesium and vitamin K.
                                            <br>
                                            <br>We buy oatmeal from a manufacturer with an international certificate confirming the absence of gluten in the product.
                                        </p>
                                        <div class="list">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="panel-content">
                                        <p class="mbr-fonts-style panel-text display-4">
                                            Contains fatty acids - MCT medium chain triglycerides. Provides fast but long-lasting energy and is easily absorbed by the body. And they also help breakdown and excretion from the body, is this not a dream?!
                                        </p>
                                        <div class="list">
                                            <p class="mbr-list-odd mbr-fonts-style display-5">
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingThree">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse3_7" aria-expanded="false" aria-controls="collapse3">
                                    ...
                                    <h5 class="panel-title-edit mbr-fonts-style display-5">
                                        <strong>TOPINAMBUR SYRUP</strong>
                                    </h5>
                                    <h6 class="panel-subtitle-edit mbr-fonts-style display-4">
                                        HEALTHY REPLACEMENT<br>OF SUGAR
                                    </h6>
                                    <span class="mobi-mbri mobi-mbri-plus mbr-iconfont"></span>
                                </a>
                            </div>
                            <div id="collapse3_7" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingThree">
                                <div class="panel-body">
                                    ...
                                    <div class="panel-content">
                                        <p class="mbr-fonts-style panel-text display-4">Topinambur syrup is a natural low glycemic index sweetener, a source of inulin and pectin. Strengthens the immune system and contains B vitamins, vitamin C, pectin, minerals and organic acids.
                                            <br>
                                            <br>We buy from local manufacturers.
                                        </p>
                                        <div class="list">
                                            <p class="mbr-list-odd mbr-fonts-style display-5">
                                                <strong>B VITAMINS</strong>
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingFour">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse4_7" aria-expanded="false" aria-controls="collapse4">
                                    ...
                                    <h5 class="panel-title-edit mbr-fonts-style display-5">
                                        <strong>PUMPKIN PROTEIN</strong>
                                    </h5>
                                    <h6 class="panel-subtitle-edit mbr-fonts-style display-4">
                                        HELP TO COPE<br>WITH STRESS
                                    </h6>
                                    <span class="mobi-mbri mobi-mbri-plus mbr-iconfont"></span>
                                </a>
                            </div>
                            <div id="collapse4_7" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingFour">
                                <div class="panel-body">
                                    ...
                                    <div class="panel-content">
                                        <p class="mbr-fonts-style panel-text display-4">Pumpkin Protein is a fat-free, ground pumpkin seed. It is 66% protein and contains 18 amino acids. Thanks to the glutamic acid and tryptophan in the composition, pumpkin protein supports a healthy brain and nervous system and helps to cope with stress.
                                            <br>Also contains vitamin E, zinc, magnesium, manganese and phosphorus.
                                        </p>
                                        <div class="list">
                                            <p class="mbr-list-odd mbr-fonts-style display-5">
                                                <strong>VITAMIN E</strong>
    ...
    <section data-bs-version="5.1" class="image2 cid-sQg6xklTFC" id="image2-8">
                    ...
                    <div class="text-wrapper">
                        <h3 class="mbr-section-title mbr-fonts-style display-2">
                            <span>
                                ...
                                <strong>EXPLORE OUR INSTAGRAM</strong>
                            </span>
                        </h3>
                        ...
                        <div class="button-container">
                            ...
                            <div class="mbr-section-btn justify-content-start">
                                <a class="btn btn-size btn-secondary display-4" href="#"><strong>SUBSCRIBE</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="image-container">
                        <div class="image-inner-container">
                            <div class="image-col col-aside">
                                <div class="tile">
                                    <div class="image-wrap">
                                        <img src="assets/images/hightlights2.jpg" alt="">
                                    </div>
                                    <div class="mbr-description">
                                        <p class="mbr-description mbr-fonts-style mt-2 display-4">
                                            Image Description
                                        </p>
                                    </div>
                                </div>
                                <div class="tile">
                                    <div class="image-wrap">
                                        <img src="assets/images/hightlights3.jpg" alt="">
                                    </div>
                                    <div class="mbr-description">
                                        <p class="mbr-description mbr-fonts-style mt-2 display-4">
                                            Image Description
                                ...
                                <div class="tile">
                                    <div class="image-wrap">
                                        <img src="assets/images/hightlights4.jpg" alt="">
                                    </div>
                                    <div class="mbr-description">
                                        <p class="mbr-description mbr-fonts-style mt-2 display-4">
                                            Image Description
                            ...
                            <div class="image-col col-middle">
                                <div class="tile">
                                    <div class="image-wrap">
                                        <img src="assets/images/hightlights5.jpg" alt="">
                                    </div>
                                    <div class="mbr-description">
                                        <p class="mbr-description mbr-fonts-style mt-2 display-4">
                                            Image Description
                                ...
                                <div class="tile">
                                    <div class="image-wrap">
                                        <img src="assets/images/hightlights6.jpg" alt="">
                                    </div>
                                    <div class="mbr-description">
                                        <p class="mbr-description mbr-fonts-style mt-2 display-4">
                                            Image Description
                                ...
                                <div class="tile">
                                    <div class="image-wrap">
                                        <img src="assets/images/hightlights7.jpg" alt="">
                                    </div>
                                    <div class="mbr-description">
                                        <p class="mbr-description mbr-fonts-style mt-2 display-4">
                                            Image Description
    ...
    <section data-bs-version="5.1" class="form1 cid-sQg6E9ILiV" id="form1-9">
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="mbr-section-head">
                        ...
                        <h3 class="mbr-section-title mbr-fonts-style display-2">
                            <span class="mbr-iconfont mobi-mbri-letter mobi-mbri" style="vertical-align: bottom;"></span>
                ...
                <div class="col-10 col-lg-6">
                    <div class="mbr-form " data-form-type="formoid">
                        <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler mx-auto" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="dxoAtUaTdI1BUl7tXbV5IyD79yVfGWXG17guekpXJl7KrcvVIVw0okZRoWs5kRxQUbIyqFZSdB0/r6I5MmKQPQVKblr7EHd7ZqjEitYWuYZuSW6srD+D0oblM00qjSWr.yo9uZioFRoLSuLqh+/+kHM6/il/P3AeRSJdCZrKEYkWgCtBGy2AyRP76K149snuP/0K82FcjSno24gILARqCrXGXmlwa0fkdLtXR6qAkv8CWNpW0cFCROoOYvYOHfblB">
                            <div class="row">
                            ...
                            <div class="dragArea row">
                                <div data-for="email" class="col-12 col-lg form-group">
                                    <input type="email" name="email" placeholder="Your Email" data-form-field="email" class="form-control" value="" id="email-form1-9">
                                </div>
                                <div class="col-12 col-lg-4 mbr-section-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 93 79" fill="none">
                                    ...
                                    <button type="submit" class="btn btn-secondary display-4"><strong>SUBSCRIBE</strong></button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <section data-bs-version="5.1" class="footer1 cid-sQg6G6blMc" once="footers" id="footer1-a">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 col-md-2 col-lg-3 media-col">
                    <div class="media-wrap col-12 col-md-10 col-lg-4">
                        <a href="#">
                            <img src="assets/images/logo.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-12 col-md-6 d-flex align-items-center cards-col">
                    <div class="cards-row">
                        <div class="card-item">
                        ...
                        <div class="card-item">
                            <img src="assets/images/tinkoff.svg" alt="">
                        </div>
                        <div class="card-item">
                            <img src="assets/images/applepay.svg" alt="">
                        </div>
                        <div class="card-item">
                            <img src="assets/images/googlepay.svg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3 d-flex align-items-center social-col">
